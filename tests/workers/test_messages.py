...
class TestSerialization:
    """Unit tests for BaseMessage serialize/deserialize."""

    def test_base_message_serialize_roundtrip(self):
    ...
    def test_document_message_serialize_roundtrip(self):
        msg = DocumentMessage(
    ...
    def test_chunk_message_serialize_roundtrip(self):
        msg = ChunkMessage(
    ...
    def test_serialize_excludes_raw(self):
    ...
    def test_serialize_includes_type_tag(self):
        msg = DocumentMessage(
